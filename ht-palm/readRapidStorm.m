...
%-----------------------------------------------------------
%-----------------------------------------------------------
function srFileStruct = readRapidStorm(fname)
%read rapidstorm XML
% outputs :
% srFileStruct.data : (n,m), n colums of frames, for m rows of parameters
% srFileStruct.parInfo	:
%   .ATTRIBUTE
...
srFileStruct.parInfo = xml_read(xmlHead);% using xml_read from xml_io_tools_2010_11_05

srFileStruct = rmfield(srFileStruct,'textdata');
