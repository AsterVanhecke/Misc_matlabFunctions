function [z, a, b, alpha, initguess] = fitEllipseOnAxisRobust(x, varargin)
...
if params.fNonlinear
    ...
    % Apply the fit
    [z, a, b, alpha] = ...
        fitnonlinear(x, z0, a0, b0, params);
end
...
function [z, a, b, alpha, fConverged] = fitnonlinear(x, z0, a0, b0, params)
...
u0 = [phi0; a0; b0; z0];
lb=[-inf*ones(size(phi0));0;0;[-Inf;-Inf]];
ub=[+inf*ones(size(phi0));maxd/2;maxd/2;[Inf;Inf]];
