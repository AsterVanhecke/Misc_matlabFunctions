function [IDX,sep,thres] = multiOtsu(I,n)
...
%   pIDX,sep,thres] also returns the threshold segmentation values 
%
%   Notes:
%   -----
...
if n==2
    ...
    %130204 SH EDIT TO expose chosen levels
    thres = pixval(k+1);
elseif n==3
    w0 = w;
